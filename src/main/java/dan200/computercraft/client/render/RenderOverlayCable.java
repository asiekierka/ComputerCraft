...
public class RenderOverlayCable
{
    ...
    public void drawHighlight( DrawBlockHighlightEvent event )
    {
        ...
        {
            RenderGlobal.drawSelectionBoundingBox( cable.getModemBounds() );
        }
        else
        {
            int flags = 0;
    ...
    private static void draw( VertexBuffer buffer, int flags, EnumFacing a, EnumFacing b, EnumFacing.Axis other )
    {
