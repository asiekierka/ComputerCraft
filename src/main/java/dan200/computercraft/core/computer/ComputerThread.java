...
public class ComputerThread
{
     ...
     */
    private static final WeakHashMap<Object, BlockingQueue<ITask>> s_computerTaskQueues = new WeakHashMap<Object, BlockingQueue<ITask>>();

    /**
     * Active queues to execute
     */
    private static final BlockingQueue<BlockingQueue<ITask>> s_computerTasksActive = new LinkedBlockingQueue<BlockingQueue<ITask>>();
    private static final Set<BlockingQueue<ITask>> s_computerTasksActiveSet = new HashSet<BlockingQueue<ITask>>();
    ...
    public static void queueTask( ITask task, Computer computer )
    {
        ...
        synchronized( s_computerTaskQueues )
        {
            ...
            if( queue == null )
            {
                s_computerTaskQueues.put( queueObject, queue = new LinkedBlockingQueue<ITask>( QUEUE_LIMIT ) );
            }
        }
